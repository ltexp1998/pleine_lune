 ...
 */
class Ps_checkout2152AdminContainer extends Container
{
    private $parameters = [];
    private $targetDirs = [];
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.6.1.24', '/Users/ltexp1998/Desktop/github/pleine_lune');
    }
