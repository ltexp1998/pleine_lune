<?php /* Smarty version Smarty-3.1.19, created on 2021-05-17 15:35:01
         compiled from "/Users/ltexp1998/Desktop/github/pleine_lune/admin195mcxra9/themes/default/template/controllers/categories/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:201481327960a27105120c68-73397695%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33df55316e40c57fe8f0fab51fb6009b27905ec4' => 
    array (
      0 => '/Users/ltexp1998/Desktop/github/pleine_lune/admin195mcxra9/themes/default/template/controllers/categories/helpers/list/list_header.tpl',
      1 => 1556635332,
      2 => 'file',
    ),
    '4fe4e7a45059602ddb193a24d6791487501b26a9' => 
    array (
      0 => '/Users/ltexp1998/Desktop/github/pleine_lune/admin195mcxra9/themes/default/template/helpers/list/list_header.tpl',
      1 => 1556635332,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '201481327960a27105120c68-73397695',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60a271054f7430_02206590',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60a271054f7430_02206590')) {function content_60a271054f7430_02206590($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/Users/ltexp1998/Desktop/github/pleine_lune/tools/smarty/plugins/function.math.php';
?>
...
" method="post">
			<div class="panel-heading">
				<?php if ($_smarty_tpl->tpl_vars['need_delete_mode']->value) {?>
					<?php echo smartyTranslate(array('s'=>'What do you want to do with the products associated with this category?'),$_smarty_tpl);?>

				<?php } else { ?>
					<?php echo smartyTranslate(array('s'=>'Deleting multiple categories'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['need_delete_mode']->value) {?>
				<div class="radio">
					<label for="deleteMode_linkanddisable">
						...
						<?php echo smartyTranslate(array('s'=>'I want to associate the products without other categories to the parent category, then disable these products for now. I re-enable them when they are moved in their new category.'),$_smarty_tpl);?>
 <strong><?php echo smartyTranslate(array('s'=>'(Recommended)'),$_smarty_tpl);?>
</strong>
					</label>
				</div>
				<div class="radio">
					<label for="deleteMode_link">
						...
						<?php echo smartyTranslate(array('s'=>'I want to associate the products without other categories to the parent category, and keep them enabled.'),$_smarty_tpl);?>
				...
				<div class="radio">
					<label for="deleteMode_delete">
						...
						<?php echo smartyTranslate(array('s'=>'I want to remove the products which are listed only within this category and no others.'),$_smarty_tpl);?>

					</label>
				</div>
			<?php } else { ?>
				<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Deleting this category will remove products linked only within this category and no others. Are you sure you want to continue?'),$_smarty_tpl);?>
</div>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['params_url']->value, ENT_QUOTES, 'UTF-8', true);?>
