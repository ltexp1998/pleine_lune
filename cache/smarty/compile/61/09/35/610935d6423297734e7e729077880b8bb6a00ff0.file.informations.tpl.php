<?php /* Smarty version Smarty-3.1.19, created on 2021-05-17 17:59:21
         compiled from "/Users/ltexp1998/Desktop/github/pleine_lune/admin195mcxra9/themes/default/template/controllers/products/informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7529869660a292d96d3222-74129686%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '610935d6423297734e7e729077880b8bb6a00ff0' => 
    array (
      0 => '/Users/ltexp1998/Desktop/github/pleine_lune/admin195mcxra9/themes/default/template/controllers/products/informations.tpl',
      1 => 1621265981,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7529869660a292d96d3222-74129686',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60a292d992d933_04214889',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60a292d992d933_04214889')) {function content_60a292d992d933_04214889($_smarty_tpl) {?>
			...
			<div class="form-group">
				...
				<div class="col-lg-3">
					<select name="condition" id="condition">
						...
						<option value="Disponible toute l\'année" <?php if ($_smarty_tpl->tpl_vars['product']->value->condition=='Disponible toute l\'année') {?>selected="selected"<?php }?> ><?php echo smartyTranslate(array('s'=>'Disponible toute l\'année'),$_smarty_tpl);?>
</option>
						<option value="Saisonnière" <?php if ($_smarty_tpl->tpl_vars['product']->value->condition=='Saisonnière') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Saisonnière'),$_smarty_tpl);?>
</option>
						<option value="Ephémère" <?php if ($_smarty_tpl->tpl_vars['product']->value->condition=='Ephémère') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Ephémère'),$_smarty_tpl);?>
</option>
					</select>
				</div>
			</div>
