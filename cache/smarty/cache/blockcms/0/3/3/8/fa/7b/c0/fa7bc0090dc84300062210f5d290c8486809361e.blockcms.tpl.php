...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_60a3c7d39afe70_00002912',
  'has_nocache_code' => true,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60a3c7d39afe70_00002912')) {function content_60a3c7d39afe70_00002912($_smarty_tpl) {?>
	<!-- Block CMS module -->
			<section id="informations_block_left_1" class="block informations_block_left">
			<p class="title_block">
				<a href="http://localhost:8888/index.php?id_cms_category=1&amp;controller=cms">
					Information				</a>
			</p>
			<div class="block_content list-block">
				<ul>
																							<li>
								<a href="http://localhost:8888/index.php?id_cms=1&amp;controller=cms" title="Delivery">
									Delivery
								</a>
							</li>
																								<li>
								<a href="http://localhost:8888/index.php?id_cms=2&amp;controller=cms" title="Legal Notice">
									Legal Notice
								</a>
							</li>
																								<li>
								...
								<a href="http://localhost:8888/index.php?id_cms=4&amp;controller=cms" title="About us">
									About us
																								...
																								<li>
								<a href="http://localhost:8888/index.php?id_cms=5&amp;controller=cms" title="Secure payment">
									Secure payment
								</a>
							</li>
																						<li>
